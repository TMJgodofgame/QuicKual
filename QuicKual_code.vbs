Private Sub QuicKual(control As IRibbonControl)
    ...
    selectedLanguage = InputBox("Select the idiom you want to use:" & vbNewLine & "1) Castellano" & vbNewLine & "2) English" & vbNewLine & "3) Gaulois")
    ...
    Select Case selectedLanguage
        ...
        Case "2"
            Dim course
            course = InputBox("What grade are you in:" & vbNewLine & "1) 1st and 2nd grade" & vbNewLine & "2) 3rd and 4th grade" & vbNewLine & "3) 5th grade and above")
...
Function English_1st_2nd()
    ...
    choice = InputBox("Select the operation you want to perform:" & vbCrLf & "1. Addition" & vbCrLf & "2. Subtraction" & vbCrLf & "3. Multiplication" & vbCrLf & "4. Long Division" & vbCrLf & "5. Factorial Decomposition", "Operation Menu")
...
Function English_from_5th_grade()
    Dim choice As String
    choice = InputBox("Select the operation you want to perform:" & vbCrLf & "1. Addition" & vbCrLf & "2. Subtraction" & vbCrLf & "3. Multiplication" & vbCrLf & "4. Long Division" & vbCrLf & "5. Factorial Decomposition" & vbCrLf & "6. Perform Roots", "Operation Menu")
